...
public abstract class TasksManagerTest<T extends TasksManager> {
    ...
    @Test
    void addNewSubtask() {
        tasksManager.addNewEpic(new Epic("Epic for Test addNewSubTask",
    ...
    void getTasks() {
        Task task1 = new Task(
                "Test#1 getTasks",
                "Test#1 getTasks description"
        );

        Task task2 = new Task(
                "Test#2 getTasks",
                "Test#2 getTasks description"
        );

        Task task3 = new Task(
                "Test#3 getTasks",
                "Test 3 getTasks description"
        );
    ...
    void getSubtasks() {
        tasksManager.addNewEpic(new Epic(
                "Epic for Test getSubtasks",
                "getSubtasks description"
        ));
    ...
    void getEpicSubtasks() {
        tasksManager.addNewEpic(new Epic(
                "Test getEpicSubtasks",
                "getEpicSubtasks description"
        ));

        SubTask subTask1 = new SubTask(
                1,
                "Test#1 getEpicSubtasks",
                "Test#1 getSubtasks description"
        );

        SubTask subTask2 = new SubTask(
                1,
                "Test#2 getEpicSubtasks",
                "Test#2 getSubtasks description"
        );

        SubTask subTask3 = new SubTask(
                1,
                "Test#3 getEpicSubtasks",
                "Test#3 getSubtasks description"
        );
    ...
    void getSubtask() {
        tasksManager.addNewEpic(new Epic(
                "Epic for Test getSubtask",
                "getSubtask description"
        ));

        SubTask subTask = new SubTask(
                1,
                "Test getSubtask",
                "Test getSubtask description"
        );
    ...
    void updateSubtask() {
        tasksManager.addNewEpic(new Epic(
                "Epic for Test updateSubtask",
                "updateSubtask description"
        ));
        ...
        SubTask updatedSubTask = new SubTask(
                2,
                1,
                "Test#2 updateSubtask",
                "Test#2 updateSubtask description",
                Status.IN_PROGRESS
        );
    ...
    void deleteSubtask() {
        tasksManager.addNewEpic(new Epic(
                "Epic for Test deleteSubtask",
                "deleteSubtask description"
        ));
        ...
        final int subTaskId = tasksManager.addNewSubtask(
                ...
                (new SubTask(
                        1,
                        "Test#1 updateSubtask",
                        "Test#1 updateSubtask description"
                )));

        SubTask subTask2 = new SubTask(
                1,
                "Test#2 deleteSubtask",
    ...
    void deleteTasks() {
        tasksManager.addNewTask(new Task(
                "Test#1 deleteTasks",
                "Test#1 deleteTasks description"
        ));

        tasksManager.addNewTask(new Task(
                "Test#2 deleteTasks",
                "Test#2 deleteTasks description"
        ));

        tasksManager.addNewTask(new Task(
                "Test#3 deleteTasks",
                "Test 3 deleteTasks description"
        ));
    ...
    void deleteSubtasks() {
        tasksManager.addNewEpic(new Epic(
                "Epic#1 for Test deleteSubtasks",
        ...
        tasksManager.addNewSubtask(
                ...
                (new SubTask(
                        1,
                        "Test#2 deleteSubtasks",
                        "Test#2 deleteSubtasks description"
                )));

        tasksManager.addNewEpic(new Epic(
                "Epic#2 for Test deleteSubtasks",
                "deleteSubtasks description"
        ));
        tasksManager.addNewSubtask(
                4,
